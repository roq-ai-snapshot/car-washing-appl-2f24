...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`car washing application`}</title>

        <meta
          name="description"
          content="Experience ultimate convenience with Car Washing Application - your reliable partner for a sparkling clean car, anytime, anywhere."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXJ8ZW58MHx8fHwxNjk3MDg0NjE5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience ultimate convenience with Car Washing Application - your reliable partner for a sparkling clean car, anytime, anywhere.`}
            </Text>
            <Box
